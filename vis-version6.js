    ...
    //getting data
	    ...
	    */
			...
			if (keyType.key == colorCode)
				...
				if (keyType.dataType=="number")
					...
					*/
					...
					string= false;
					var minMax;
					minMax = "Minimum " + keyType.key + ": " + keyType.keyMin + "\nMaximum " + keyType.key + ": "  + keyType.keyMax;; 
					var divWords = document.createElement("div");
					divWords.innerText= minMax
					    divWords.style.fontSize = heightOfText + "px";
					divWords.style.position = "relative";
					divWords.style.fontFamily = "sans-serif";
					divWords.style.top="1px";
					
					list.appendChild(divWords);
					//max = "Maximum " + keyType.key + ": "  + keyType.keyMax;
					//divWords.textContent = max
					//list.appendChild(divWords);
	    ...
	    $("#selectColorCode").change(function(e) {
			...
			//var divRemove = document.getElementById("hist");
			//if(divRemove!=null)
			//    divRemove.style.display = "hidden";
